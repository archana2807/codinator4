...
<html lang="zxx">
	<head>
		...
		<!-- Favicon Icon -->
		<link rel="icon" type="image/png" href="<?php echo base_url();?>assets/img/favcion.png" />
			...
			<div class="container">
				<div class="row flexbox-center">
					<div class="col-lg-2 col-md-3 col-6">
						<div class="logo">
							<a href="#home"><img src="<?php echo base_url();?>uploads\gmlm-gold-logo.svg" alt="logo" /></a>
						</div>
					</div>
					<div class="col-lg-10 col-md-9 col-6">
					    ...
					    <div class="mainmenu">
                            <ul id="primary-menu">
                                ...
                                <li><a class="nav-link" href="<?php echo base_url();?>welcome/blog">Blog</a></li>
								<li><a class="nav-link" href="<?php echo base_url();?>welcome/blog_detail">Blog Detail</a></li>
                                <li><a class="nav-link" href="#contact">Contact Us</a></li>
                                <li><a class="appao-btn" href="javascript:void(0);" class="register  " data-toggle="modal" data-target="#my_vastu_edit" >Registration</a></li>
                            </ul>
					    </div>
					</div>
				</div>
