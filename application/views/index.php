<?php $this->load->view('components/header'); ?>
		...
		<div class="modal fade" id="my_vastu_edit" tabindex="-1" course_package="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content" >
            <div class="modal-header">
               
                <h3 id="heading" class="heading">Add Your Address</h3>
            ...
            <div class="modal-body row">
				<div class="col-md-12">
				 <span id="success_message"></span>
					<form class="category_form2" id="category_form2" method="post" enctype="multipart/form-data">
					<div class="alert alert-danger display-live-err-msg" style="display:none">
    </div>
					    
						<input class="form-control" id="update_id" name="update_id" value=0 type="hidden">
						<div class="form-group col-md-12" style="">
							<label class="control-label col-md-6" for="category_status">Name<span class="required">*</span></label>
							<div class="col-md-12">
					     ...
					     <div class="form-group col-md-12" style="">
							<label class="control-label col-md-6" for="category_status">Email<span class="required">*</span></label>
							<div class="col-md-12">
								<input class="form-control" id="email" name="email" type="email" value="" placeholder="Enter email">
								<span id="email_error" class="text-danger"></span>
							</div>
						</div>
						<div class="form-group col-md-12" style="">
							<label class="control-label col-md-6" for="category_status">Phone<span class="required">*</span></label>
							<div class="col-md-12">
								<input class="form-control" id="phone" name="phone" type="number" value="" placeholder="Enter  phone">
								<span id="phone_error" class="text-danger"></span>
							</div>
						</div>
						<div class="form-group col-md-12" style="">
							<label class="control-label col-md-6" for="category_status">Address<span class="required">*</span></label>
							<div class="col-md-12">
								<input class="form-control" id="address" name="address" type="text" value="" placeholder="Enter  address">
						...
						<div class="form-group col-md-12" style="">
							...
							<div class="col-md-12">
								<button class="btn form-control" id="submit" name="submit" type="submit" value="submit" >submit</button>
							</div>
						</div>
...
$(document).ready(function(){
 ...
 $('#category_form2').on('submit', function(event){
